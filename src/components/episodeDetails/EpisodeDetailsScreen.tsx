...
const EpisodeDetailsScreen = () => {
  ...
  const {
    episode: {image, title, linkUrl, duration, description},
    podcast: {thumbnail, artist},
  } = (useRoute().params ?? {}) as {
        ...
        <View style={tailwind('px-4')}>
          <View style={tailwind('my-4 flex-row')}>
            <Image
              ...
              style={tailwind('h-16 w-16 mr-4 rounded-lg')}
            />
          ...
          <View
            style={[
              ...
              tailwind('mb-4 bg-gray-300'),
            ]}
          />

          <View>
            <Text style={tailwind('mb-4 text-lg font-bold')}>
              Episode Notes
            </Text>
